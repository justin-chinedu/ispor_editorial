    ...
    return (
        <footer className="bg-gray-800 h-64 justify-end items-center">
            <div className=" h-full flex flex-col items-center justify-end gap-y-1 py-6 opacity-70">
                <p className="text-white text-sm font-medium">Made With <span className="text-red-500"><Favorite/></span> by <a href="mailto://chinedujustin491@gmail.com" className="underline select-none">Justin Chinedu</a></p>
